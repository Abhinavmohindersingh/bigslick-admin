...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 shadow-2xl z-40 transform transition-transform duration-300 ${
        ...
        <nav className="mt-6 px-4 flex-1 overflow-y-auto">
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`w-5 h-5 mr-3 ${isActive ? "text-orange-400" : "text-gray-400"}`}
                />
